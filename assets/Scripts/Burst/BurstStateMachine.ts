...
export class BurstStateMachine extends StateMachine {
    ...
    initSateMachine() {
        this.stateMachine.set(PARAMS_NAME_TYPE.IDLE, new State(this, BASE_URL + 'idle/idle',))
        this.stateMachine.set(PARAMS_NAME_TYPE.ATTACK, new State(this, BASE_URL + 'attack/idle'))
        this.stateMachine.set(PARAMS_NAME_TYPE.DEATH, new State(this, BASE_URL + 'death/idle'))
    }
