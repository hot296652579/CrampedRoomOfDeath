    ...
    execute: function () {
      ...
      _export("ShakeManager", ShakeManager = (_dec = ccclass('ShakeManager'), _dec(_class = class ShakeManager extends Component {
        ...
        onShakeUpdate() {
          if (this.isShaking) {
            //振幅
            const shakeAmount = 1.6; //持续时间

            const duration = 200; //频率

            const frequency = 12; //当前时间

            const curSecond = (game.totalTime - this.oldTime) / 1000; //总时间
...
//# sourceMappingURL=d1335a17095a24a724babfcef092b5a4e1dbfde9.js.map