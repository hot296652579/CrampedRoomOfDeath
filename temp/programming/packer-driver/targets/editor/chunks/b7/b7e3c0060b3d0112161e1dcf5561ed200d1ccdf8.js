      ...
      _export("default", FadeMgr = class FadeMgr extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        ...
        get fader() {
          if (this._fader) {
            ...
            const root = (_crd && createNewNode === void 0 ? (_reportPossibleCrUseOfcreateNewNode({
              error: Error()
            }), createNewNode) : createNewNode)();
            root.addComponent(RenderRoot2D);
            const fadeNode = (_crd && createNewNode === void 0 ? (_reportPossibleCrUseOfcreateNewNode({
              error: Error()
            }), createNewNode) : createNewNode)();
        ...
        fadeIn(duration = _crd && DEFAULT_FADE_DURATION === void 0 ? (_reportPossibleCrUseOfDEFAULT_FADE_DURATION({
          error: Error()
        }), DEFAULT_FADE_DURATION) : DEFAULT_FADE_DURATION) {
          return this._fader.fadeIn(duration);
        }

        fadeOut(duration = _crd && DEFAULT_FADE_DURATION === void 0 ? (_reportPossibleCrUseOfDEFAULT_FADE_DURATION({
          error: Error()
        }), DEFAULT_FADE_DURATION) : DEFAULT_FADE_DURATION) {
...
//# sourceMappingURL=b7e3c0060b3d0112161e1dcf5561ed200d1ccdf8.js.map