  ...
  return {
    ...
    execute: function () {
      ...
      _export("WoodenMgr", WoodenMgr = (_dec = ccclass('WoodenMgr'), _dec(_class = class WoodenMgr extends (_crd && EnemyMgr === void 0 ? (_reportPossibleCrUseOfEnemyMgr({
        ...
        onLoad() {
          super.onLoad(); // EventMgr.Instance.addEventListen(ENUM_EVENT.ENUM_MOVE_END, this.checkAttack, this)
        }

        onDestroy() {
          super.onDestroy(); // EventMgr.Instance.unEventListen(ENUM_EVENT.ENUM_MOVE_END, this.checkAttack)
        }
...
//# sourceMappingURL=07f4103e36507078ae60c0b9c93621c30d6122a0.js.map