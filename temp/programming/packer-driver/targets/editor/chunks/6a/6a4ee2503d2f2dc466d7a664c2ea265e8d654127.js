    ...
    execute: function () {
      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class UIBattleScene extends Component {
        ...
        async initLevel() {
          ...
          await Promise.all([this.generateTileMap(), this.generateBurst(), this.generateEnemies(), this.generateSpikes(), this.generateDoor(), this.generateSmokeLayer(), this.fitPos()]);
...
//# sourceMappingURL=6a4ee2503d2f2dc466d7a664c2ea265e8d654127.js.map