System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, PARAMS_NAME_TYPE, getParamsInitNumber, getParamsInitTrigger, StateMachine, AudioMgr, DeathIronSubStateMachine, IdleIronSubStateMachine, _dec, _class, _crd, ccclass, property, IronStateMachine;
            ...
            case this.stateMachine.get((_crd && PARAMS_NAME_TYPE === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_TYPE({
              ...
              if (this.params.get((_crd && PARAMS_NAME_TYPE === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_TYPE({
                ...
                (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
                  error: Error()
                }), AudioMgr) : AudioMgr).inst.playOneShot('sound/enemyDeath');
              } else {
...
//# sourceMappingURL=395a050763277c52128f509fdc3e248e0a98f178.js.map