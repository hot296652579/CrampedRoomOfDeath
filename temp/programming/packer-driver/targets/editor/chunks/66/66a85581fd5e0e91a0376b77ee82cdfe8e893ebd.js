    ...
    execute: function () {
      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec(_class = class UIBattleScene extends Component {
        ...
        async generateSpikes() {
          const spikesNode = (_crd && createNewNode === void 0 ? (_reportPossibleCrUseOfcreateNewNode({
            error: Error()
          }), createNewNode) : createNewNode)();
          spikesNode.setParent(this.stage);
          const spikesManager = spikesNode.addComponent(_crd && SpikesMgr === void 0 ? (_reportPossibleCrUseOfSpikesMgr({
            error: Error()
          }), SpikesMgr) : SpikesMgr);
...
//# sourceMappingURL=66a85581fd5e0e91a0376b77ee82cdfe8e893ebd.js.map