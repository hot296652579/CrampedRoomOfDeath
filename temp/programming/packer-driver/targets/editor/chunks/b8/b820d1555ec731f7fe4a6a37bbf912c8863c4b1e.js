System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, _decorator, Node, ENITIY_TYPE_ENUM, ENTITY_STATE_ENUM, ENUM_EVENT, levels, EventMgr, BurstMgr, DoorMgr, IronMgr, WoodenMgr, PlayerMrg, AudioMgr, DataManager, FadeMgr, ShakeManager, SmokeMgr, SpikesMgr, TileMapManager, createNewNode, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, TILE_WIDTH, TILE_HEIGHT, ccclass, property, UIBattleScene;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class UIBattleScene extends Component {
        constructor(...args) {
          super(...args);
          this.level = void 0;
          this.stage = void 0;
        ...
        start() {
          ...
          (_crd && AudioMgr === void 0 ? (_reportPossibleCrUseOfAudioMgr({
            error: Error()
          }), AudioMgr) : AudioMgr).inst.play('sound/bg', 1, true);
          (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance.levelIndex = 3;
          this.generateStage();
          this.initLevel();
        ...
        async initLevel() {
          ...
          if (this.level) {
            ...
            (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            }), DataManager) : DataManager).Instance.mapColumCount = ((_this$level$mapInfo$ = this.level.mapInfo[0]) == null ? void 0 : _this$level$mapInfo$.length) || 0; //列
...
//# sourceMappingURL=b820d1555ec731f7fe4a6a37bbf912c8863c4b1e.js.map