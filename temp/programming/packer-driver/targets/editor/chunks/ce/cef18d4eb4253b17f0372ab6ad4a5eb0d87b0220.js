  ...
  return {
    ...
    execute: function () {
      ...
      _export("TileMapManager", TileMapManager = (_dec = ccclass('TileMapManager'), _dec(_class = class TileMapManager extends Component {
        ...
        async init() {
          const spriteFrames = await this.loadRes(); // console.log(spriteFrames)
          ...
          for (let index = 0; index < mapInfo.length; index++) {
            ...
            for (let j = 0; j < colnum.length; j++) {
              ...
              node.setPosition(TILE_WIDTH * index, TILE_HEIGHT * j);
            }
          }
        }
...
//# sourceMappingURL=cef18d4eb4253b17f0372ab6ad4a5eb0d87b0220.js.map