System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, AnimationClip, DIRECTION_ENUM, DIRECTION_ORDER_ENUM, PARAMS_NAME_TYPE, State, SubStateMachine, IdleSubStateMachine, _crd, BASE_URL, BASE_END;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "547f4ivGqBBQK7ddXBl3QSK", "IdleSubStateMachine", undefined);
      ...
      _export("default", IdleSubStateMachine = class IdleSubStateMachine extends (_crd && SubStateMachine === void 0 ? (_reportPossibleCrUseOfSubStateMachine({
        ...
        run() {
          const direction = this.fsm.getParams((_crd && PARAMS_NAME_TYPE === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_TYPE({
            error: Error()
          ...
          this.currentSate = this.stateMachine.get((_crd && DIRECTION_ORDER_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ORDER_ENUM({
            error: Error()
          }), DIRECTION_ORDER_ENUM) : DIRECTION_ORDER_ENUM)[Number(direction)]);
        }
...
//# sourceMappingURL=9d8f80ab9c4d2d9bd791eb1460490593a1c7bba1.js.map