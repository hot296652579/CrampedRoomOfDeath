    ...
    execute: function () {
      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class UIBattleScene extends Component {
        ...
        async initLevel() {
          ...
          await Promise.all([this.generateTileMap(), // this.generateBurst(),
          this.generateEnemies(), // this.generateSpikes(),
          this.generateDoor(), this.generateSmokeLayer(), this.fitPos()]);
...
//# sourceMappingURL=312de4d4ecd5c409ba7065a2aaa0fbbf52c7acea.js.map