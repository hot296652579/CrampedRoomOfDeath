System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, DIRECTION_ENUM, DirectionSubStateMachine, State, BlockFontSubStateMachine, _crd, BASE_URL, BASE_END;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ee30fMnwFlOWoJeDKhxJ5mT", "BlockFontSubStateMachine", undefined);

      __checkObsolete__(['AnimationClip']);

      BASE_URL = 'texture/player/blockfont/';
      BASE_END = '/blockfont';

      _export("default", BlockFontSubStateMachine = class BlockFontSubStateMachine extends (_crd && DirectionSubStateMachine === void 0 ? (_reportPossibleCrUseOfDirectionSubStateMachine({
        error: Error()
...
//# sourceMappingURL=b6427a3d65b94be7276fca9c13de2f0127fc9aeb.js.map