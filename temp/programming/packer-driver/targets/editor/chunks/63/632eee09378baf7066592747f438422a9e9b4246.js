      ...
      _export("TileMapManager", TileMapManager = (_dec = ccclass('TileMapManager'), _dec(_class = class TileMapManager extends Component {
        ...
        async init() {
          ...
          for (let i = 0; i < mapInfo.length; i++) {
            ...
            (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            }), DataManager) : DataManager).Instance.tileMgrInfo[i] = [];
            ...
            for (let j = 0; j < colnum.length; j++) {
              ...
              (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
                error: Error()
              }), DataManager) : DataManager).Instance.tileMgrInfo[i][j] = tileManager;
              tileManager.init(type, sp, {
                i,
                j
              });
...
//# sourceMappingURL=632eee09378baf7066592747f438422a9e9b4246.js.map