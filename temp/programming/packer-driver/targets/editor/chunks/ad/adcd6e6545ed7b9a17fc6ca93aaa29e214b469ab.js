    ...
    execute: function () {
      ...
      _export("WoodenMgr", WoodenMgr = (_dec = ccclass('WoodenMgr'), _dec(_class = class WoodenMgr extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        checkAttack() {
          ...
          if ((this.x === playerX && disY <= 1 || this.y === playerY && disX <= 1) && playerState != (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
            error: Error()
...
//# sourceMappingURL=adcd6e6545ed7b9a17fc6ca93aaa29e214b469ab.js.map