  ...
  return {
    ...
    execute: function () {
      ...
      _export("DrawManager", DrawManager = (_dec = ccclass('DrawManager'), _dec(_class = class DrawManager extends Component {
        ...
        update() {
          var fadePercent = (game.totalTime - this.oldTime) / this.duration; // console.log('fadePercent:', fadePercent)
...
//# sourceMappingURL=0c081d79e1d0754ecbcbd4f203480fcb6f03215b.js.map