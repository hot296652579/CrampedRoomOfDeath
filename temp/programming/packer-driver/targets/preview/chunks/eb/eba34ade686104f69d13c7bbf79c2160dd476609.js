    ...
    execute: function () {
      ...
      _export("PlayerMrg", PlayerMrg = (_dec = ccclass('PlayerMrg'), _dec(_class = class PlayerMrg extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        updateXY() {
          ...
          if (Math.abs(this.targetX - this.x) <= 0.001 && Math.abs(this.targetY - this.y) <= 0.001 && this.isMoving) {
            this.x = this.targetX;
            this.y = this.targetY;
            this.isMoving = false;
            (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
...
//# sourceMappingURL=eba34ade686104f69d13c7bbf79c2160dd476609.js.map