System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, DIRECTION_ENUM, ENTITY_STATE_ENUM, ENUM_EVENT, ENUM_BOTTOM_CONTROLLER, SHAKE_TYPE_ENUM, EventMgr, DataManager, PlayerStateMachine, EnitiyMgr, SoundMgr, _dec, _class, _crd, MOVE_SPEED, ccclass, property, PlayerMrg;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SoundMgr = _unresolved_7.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("PlayerMrg", PlayerMrg = (_dec = ccclass('PlayerMrg'), _dec(_class = class PlayerMrg extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        inputHanlder(inputDirection) {
          ...
          if (enemyId) {
            (_crd && SoundMgr === void 0 ? (_reportPossibleCrUseOfSoundMgr({
              error: Error()
            }), SoundMgr) : SoundMgr).Instance.playSound('sound/attack');
        ...
        onDeathHanlder(type) {
          ...
          (_crd && SoundMgr === void 0 ? (_reportPossibleCrUseOfSoundMgr({
            error: Error()
          }), SoundMgr) : SoundMgr).Instance.playSound('sound/death');
        }
        ...
        willBlock(inputDirection) {
          ...
          console.log('mapColumCount', mapColumCount, 'mapRowCount', mapRowCount); //先判断输入上时候
          ...
          if (inputDirection === (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
            ...
            var playerNextY = y - 1;
            var playerNextX = x - 1;
            console.log('playerNextY', playerNextY); //玩家方向——向上
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              if (!checkBurst) return checkBurst; //最后判断地图元素
              ...
              if (checkEnemy) return checkEnemy; //玩家方向——向下
              ...
              var _checkBurst = this.checkBurstCollision(playerNextY, _nextWeaponTile, inputDirection);

              if (!_checkBurst) return _checkBurst; //最后判断地图元素
              ...
              var _checkBurst2 = this.checkBurstCollision(playerNextX, _nextWeaponTile2, inputDirection);

              if (!_checkBurst2) return _checkBurst2; //最后判断地图元素
              ...
              var _checkBurst3 = this.checkBurstCollision(playerNextX, _nextWeaponTile3, inputDirection);

              if (!_checkBurst3) return _checkBurst3; //最后判断地图元素
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              if (_checkEnemy4) return _checkEnemy4;

              var _checkBurst4 = this.checkBurstCollision(_playerNextX, _nextWeaponTile4, inputDirection);

              if (!_checkBurst4) return _checkBurst4; //玩家方向——向下
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).BOTTOM) {
              ...
              var _checkBurst5 = this.checkBurstCollision(_playerNextX, _nextWeaponTile5, inputDirection);

              if (!_checkBurst5) return _checkBurst5; //玩家方向——向左
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).LEFT) {
              ...
              var _checkEnemy5 = this.checkCollisionEnenies(_playerNextX, _weaponNextX4, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy5) return _checkEnemy5;

              var _checkBurst6 = this.checkBurstCollision(_playerNextX, _nextWeaponTile6, inputDirection);

              if (!_checkBurst6) return _checkBurst6; //玩家方向——向右
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).RIGHT) {
              ...
              var _checkEnemy6 = this.checkCollisionEnenies(_playerNextX, _weaponNextX5, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy6) return _checkEnemy6;

              var _checkBurst7 = this.checkBurstCollision(_playerNextX, _nextWeaponTile7, inputDirection);

              if (!_checkBurst7) return _checkBurst7;
            }
          } else if (inputDirection === (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
            error: Error()
          }), ENUM_BOTTOM_CONTROLLER) : ENUM_BOTTOM_CONTROLLER).RIGHT) {
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              if (_playerNextX2 > mapRowCount - 1) {
                this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                  error: Error()
                }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKRIGHT;
                return true;
              ...
              var _nextWeaponTile8 = (_tileMgrInfo$_weaponN6 = tileMgrInfo[_weaponNextX6]) == null ? void 0 : _tileMgrInfo$_weaponN6[_weaponNextY6];

              var _checkBurst8 = this.checkBurstCollision(_playerNextX2, _nextWeaponTile8, inputDirection);

              if (!_checkBurst8) return _checkBurst8; //最后判断地图元素
              ...
              var _checkEnemy7 = this.checkCollisionEnenies(_playerNextX2, _weaponNextX6, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy7) return _checkEnemy7; //玩家方向——向下
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).BOTTOM) {
              ...
              var _nextWeaponTile9 = (_tileMgrInfo$_weaponN7 = tileMgrInfo[_weaponNextX7]) == null ? void 0 : _tileMgrInfo$_weaponN7[_weaponNextY7];

              var _checkBurst9 = this.checkBurstCollision(_playerNextX2, _nextWeaponTile9, inputDirection);

              if (!_checkBurst9) return _checkBurst9; //最后判断地图元素
              ...
              var _checkEnemy8 = this.checkCollisionEnenies(_playerNextX2, _weaponNextX7, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy8) return _checkEnemy8; //玩家方向——向左
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).LEFT) {
              ...
              var _nextWeaponTile10 = (_tileMgrInfo$_weaponN8 = tileMgrInfo[_weaponNextX8]) == null ? void 0 : _tileMgrInfo$_weaponN8[y];

              var _checkBurst10 = this.checkBurstCollision(_playerNextX2, _nextWeaponTile10, inputDirection);

              if (!_checkBurst10) return _checkBurst10; //最后判断地图元素
              ...
              var _checkEnemy9 = this.checkCollisionEnenies(_playerNextX2, _weaponNextX8, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy9) return _checkEnemy9; //玩家方向——向右
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).RIGHT) {
              ...
              var _nextWeaponTile11 = (_tileMgrInfo$_weaponN9 = tileMgrInfo[_weaponNextX9]) == null ? void 0 : _tileMgrInfo$_weaponN9[y];

              var _checkBurst11 = this.checkBurstCollision(_playerNextX2, _nextWeaponTile11, inputDirection);

              if (!_checkBurst11) return _checkBurst11; //最后判断地图元素
              ...
              var _checkEnemy10 = this.checkCollisionEnenies(_playerNextX2, _weaponNextX9, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy10) return _checkEnemy10;
            }
          } else if (inputDirection === (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
            error: Error()
          }), ENUM_BOTTOM_CONTROLLER) : ENUM_BOTTOM_CONTROLLER).BOTTOM) {
            ...
            console.log('playerNextY', _playerNextY2); //玩家方向——向上
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              var _nextWeaponTile12 = (_tileMgrInfo$x8 = tileMgrInfo[x]) == null ? void 0 : _tileMgrInfo$x8[_weaponNextY8];

              var _checkBurst12 = this.checkBurstCollision(_playerNextY2, _nextWeaponTile12, inputDirection);

              if (!_checkBurst12) return _checkBurst12; //最后判断地图元素
              ...
              var _checkDoor12 = this.checkCollisionDoor(_playerNextY2, _weaponNextY8, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkDoor12) return _checkDoor12;

              var _checkEnemy11 = this.checkCollisionEnenies(_playerNextY2, _weaponNextY8, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkEnemy11) return _checkEnemy11; //玩家方向——向下
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).BOTTOM) {
              ...
              var _nextWeaponTile13 = (_tileMgrInfo$x10 = tileMgrInfo[x]) == null ? void 0 : _tileMgrInfo$x10[_weaponNextY9];

              var _checkBurst13 = this.checkBurstCollision(_playerNextY2, _nextWeaponTile13, inputDirection);

              if (!_checkBurst13) return _checkBurst13; //最后判断地图元素
              ...
              var _checkDoor13 = this.checkCollisionDoor(_playerNextY2, _weaponNextY9, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);
              ...
              if (_checkEnemy12) return _checkEnemy12; //玩家方向——向左
            } else if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              error: Error()
            }), DIRECTION_ENUM) : DIRECTION_ENUM).LEFT) {
              ...
              var _nextWeaponTile14 = (_tileMgrInfo$_weaponN10 = tileMgrInfo[_weaponNextX10]) == null ? void 0 : _tileMgrInfo$_weaponN10[_weaponNextY10];

              var _checkBurst14 = this.checkBurstCollision(_playerNextY2, _nextWeaponTile14, inputDirection);

              if (!_checkBurst14) return _checkBurst14; //最后判断地图元素
              ...
              var _checkDoor14 = this.checkCollisionDoor(_playerNextY2, _weaponNextY10, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);
              ...
              var _nextWeaponTile15 = (_tileMgrInfo$_weaponN11 = tileMgrInfo[_weaponNextX11]) == null ? void 0 : _tileMgrInfo$_weaponN11[_weaponNextY11];

              var _checkBurst15 = this.checkBurstCollision(_playerNextY2, _nextWeaponTile15, inputDirection);

              if (!_checkBurst15) return _checkBurst15; //最后判断地图元素
              ...
              var _checkDoor15 = this.checkCollisionDoor(_playerNextY2, _weaponNextY11, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkDoor15) return _checkDoor15;
        ...
        handlerMove(direction) {
          ...
          switch (direction) {
            case (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
              ...
              (_crd && SoundMgr === void 0 ? (_reportPossibleCrUseOfSoundMgr({
                error: Error()
              }), SoundMgr) : SoundMgr).Instance.playSound('sound/move');
              break;
...
//# sourceMappingURL=409af2350f83c472b8d520772b04744e3f185627.js.map