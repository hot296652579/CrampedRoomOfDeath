  ...
  return {
    ...
    execute: function () {
      ...
      _export("sortSpriteFrame", sortSpriteFrame = spFrames => {
        var newFrames = [];
        spFrames.forEach(element => {
          newFrames.push(element);
        });
        return newFrames.sort((a, b) => getNumByName(a.name) - getNumByName(b.name));
      });
...
//# sourceMappingURL=e8979cf81f61d09588056defb34e48836c7c68d4.js.map