System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, PARAMS_NAME_TYPE, IdleSubStateMachine, TurnLeftSubStateMachine, getParamsInitNumber, getParamsInitTrigger, StateMachine, _dec, _class, _crd, ccclass, property, PlayerStateMachine;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      IdleSubStateMachine = _unresolved_3.default;
    }, function (_unresolved_4) {
      TurnLeftSubStateMachine = _unresolved_4.default;
    }, function (_unresolved_5) {
      getParamsInitNumber = _unresolved_5.getParamsInitNumber;
      getParamsInitTrigger = _unresolved_5.getParamsInitTrigger;
      StateMachine = _unresolved_5.StateMachine;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("PlayerStateMachine", PlayerStateMachine = (_dec = ccclass('PlayerStateMachine'), _dec(_class = class PlayerStateMachine extends (_crd && StateMachine === void 0 ? (_reportPossibleCrUseOfStateMachine({
        ...
        initSateMachine() {
          ...
          this.stateMachine.set((_crd && PARAMS_NAME_TYPE === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_TYPE({
            error: Error()
          }), PARAMS_NAME_TYPE) : PARAMS_NAME_TYPE).BLOCKFRONT, new (_crd && IdleSubStateMachine === void 0 ? (_reportPossibleCrUseOfIdleSubStateMachine({
            error: Error()
          }), IdleSubStateMachine) : IdleSubStateMachine)(this));
        }
...
//# sourceMappingURL=9a51fb89913770a8dda53a61baa2a9065f2916be.js.map