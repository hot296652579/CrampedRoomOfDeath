      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class UIBattleScene extends Component {
        ...
        initLevel() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield Promise.all([_this.generateTileMap(), // this.generateBurst(),
            _this.generateEnemies(), // this.generateSpikes(),
            _this.generateDoor(), _this.generateSmokeLayer(), _this.fitPos()]);
...
//# sourceMappingURL=9f278a4e357e871b10a8dca4c1edafd9b2475613.js.map