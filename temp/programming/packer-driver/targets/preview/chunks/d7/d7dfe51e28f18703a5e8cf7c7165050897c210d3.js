  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerMrg", PlayerMrg = (_dec = ccclass('PlayerMrg'), _dec(_class = class PlayerMrg extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        onDeathHanlder(type) {
          this.state = type; // SoundMgr.Instance.playSound('sound/death')
        }
        ...
        handlerMove(direction) {
          ...
          switch (direction) {
            case (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
              ...
              this.tartgetY -= 1; // SoundMgr.Instance.playSound('sound/move')
            ...
            case (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
              ...
              this.isMoving = true;
              this.onSmokeHandler(direction);
              this.tartgetX -= 1; // SoundMgr.Instance.playSound('sound/move')
...
//# sourceMappingURL=d7dfe51e28f18703a5e8cf7c7165050897c210d3.js.map