System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, DIRECTION_ENUM, ENITIY_TYPE_ENUM, ENTITY_STATE_ENUM, ENUM_EVENT, EnitiyMgr, EventMgr, DataManager, DoorStateMachine, _dec, _class, _crd, MOVE_SPEED, ccclass, property, DoorMgr;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4c17aawvIBPYb0Zg1be/57E", "DoorMgr", undefined);
      ...
      _export("DoorMgr", DoorMgr = (_dec = ccclass('DoorMgr'), _dec(_class = class DoorMgr extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        error: Error()
      }), EnitiyMgr) : EnitiyMgr) {
        init() {
          ...
          return _asyncToGenerator(function* () {
            _this.fsm = _this.addComponent(_crd && DoorStateMachine === void 0 ? (_reportPossibleCrUseOfDoorStateMachine({
              error: Error()
        ...
        onLoad() {
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), ENUM_EVENT) : ENUM_EVENT).ENUM_OPEN_DOOR, this.onOpen, this);
        }
        ...
        onDestry() {
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), ENUM_EVENT) : ENUM_EVENT).ENUM_OPEN_DOOR, this.onOpen);
        }
...
//# sourceMappingURL=9b6554621f64d06195b40af32ac8bbba089f5189.js.map