System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, PARAMS_NAME_TYPE, getParamsInitTrigger, StateMachine, _dec, _class, _crd, ccclass, property, SmokeStateMachine;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7e756EI51tFU7JQxB6+7g6F", "SmokeStateMachine", undefined);
      ...
      _export("SmokeStateMachine", SmokeStateMachine = (_dec = ccclass('SmokeStateMachine'), _dec(_class = class SmokeStateMachine extends (_crd && StateMachine === void 0 ? (_reportPossibleCrUseOfStateMachine({
        ...
        initSateMachine() {
          this.stateMachine.set((_crd && PARAMS_NAME_TYPE === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_TYPE({
            error: Error()
          }), PARAMS_NAME_TYPE) : PARAMS_NAME_TYPE).IDLE, new IdleSubStateMachine(this));
          this.stateMachine.set((_crd && PARAMS_NAME_TYPE === void 0 ? (_reportPossibleCrUseOfPARAMS_NAME_TYPE({
            error: Error()
          }), PARAMS_NAME_TYPE) : PARAMS_NAME_TYPE).DEATH, new DeathSubStateMachine(this));
        }
...
//# sourceMappingURL=f614b0b5e6714b8f16eca851e20974596b9e1254.js.map