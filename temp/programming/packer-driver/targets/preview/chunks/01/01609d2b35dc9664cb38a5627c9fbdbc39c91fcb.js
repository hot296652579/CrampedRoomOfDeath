  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", State = class State {
        ...
        run() {
          if (!this.fsm.animationCom && this.fsm.animationCom.defaultClip.name === this.animationClip.name) return;
...
//# sourceMappingURL=01609d2b35dc9664cb38a5627c9fbdbc39c91fcb.js.map