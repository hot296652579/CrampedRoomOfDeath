    ...
    execute: function () {
      ...
      _export("PlayerMrg", PlayerMrg = (_dec = ccclass('PlayerMrg'), _dec(_class = class PlayerMrg extends Component {
        ...
        updateXY() {
          ...
          console.log('this.tartgetX', this.tartgetX);
        ...
        loadRes() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var transform = _this2.node.getComponent(UITransform);
            ...
            var animationCom = _this2.addComponent(Animation);
...
//# sourceMappingURL=187e686f42bc601fdac328907a27d6b234ec6090.js.map