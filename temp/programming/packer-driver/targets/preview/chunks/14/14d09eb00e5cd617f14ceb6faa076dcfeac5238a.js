System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, DIRECTION_ENUM, DirectionSubStateMachine, State, DeathSubStateMachine, _crd, BASE_URL, BASE_END;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "bdbb2vX+SNFcbfHuANiCOIJ", "DeathSubStateMachine", undefined);
      ...
      _export("default", DeathSubStateMachine = class DeathSubStateMachine extends (_crd && DirectionSubStateMachine === void 0 ? (_reportPossibleCrUseOfDirectionSubStateMachine({
        ...
        constructor(fsm) {
          ...
          this.stateMachine.set((_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
            ...
            error: Error()
          }), State) : State)(fsm, BASE_URL + BASE_END));
          this.stateMachine.set((_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
            error: Error()
...
//# sourceMappingURL=14d09eb00e5cd617f14ceb6faa076dcfeac5238a.js.map