System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, PARAMS_NAME_TYPE, ENTITY_STATE_ENUM, BlockFrontSubStateMachine, BlockTurnLeftSubStateMachine, BlockTurnRightSubStateMachine, IdleSubStateMachine, TurnLeftSubStateMachine, TurnRightSubStateMachine, EnitiyMgr, getParamsInitNumber, getParamsInitTrigger, StateMachine, _dec, _class, _crd, ccclass, property, PlayerStateMachine;
  ...
  function _reportPossibleCrUseOfBlockTurnRightSubStateMachine(extras) {
    _reporterNs.report("BlockTurnRightSubStateMachine", "../Player/BlockTurnRightSubStateMachine", _context.meta, extras);
  }
  ...
  function _reportPossibleCrUseOfTurnRightSubStateMachine(extras) {
    _reporterNs.report("TurnRightSubStateMachine", "../Player/TurnRightSubStateMachine", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      BlockTurnRightSubStateMachine = _unresolved_5.default;
    }, function (_unresolved_6) {
      IdleSubStateMachine = _unresolved_6.default;
    }, function (_unresolved_7) {
      TurnLeftSubStateMachine = _unresolved_7.default;
    }, function (_unresolved_8) {
      TurnRightSubStateMachine = _unresolved_8.default;
    }, function (_unresolved_9) {
      EnitiyMgr = _unresolved_9.EnitiyMgr;
    }, function (_unresolved_10) {
      getParamsInitNumber = _unresolved_10.getParamsInitNumber;
      getParamsInitTrigger = _unresolved_10.getParamsInitTrigger;
      StateMachine = _unresolved_10.StateMachine;
    }],
    execute: function () {
      _crd = true;
...
//# sourceMappingURL=e65c0481aa41aff01ebf92974fc5014e5316757a.js.map