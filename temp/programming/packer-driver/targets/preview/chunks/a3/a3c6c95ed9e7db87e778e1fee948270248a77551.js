System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SmokeMgr = _unresolved_11.SmokeMgr;
    }, function (_unresolved_12) {
      SpikesMgr = _unresolved_12.SpikesMgr;
    }, function (_unresolved_13) {
      TileMapManager = _unresolved_13.TileMapManager;
    }, function (_unresolved_14) {
      createNewNode = _unresolved_14.createNewNode;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec(_class = class UIBattleScene extends Component {
        ...
        showSmokeHandler(x, y, direction) {
          ...
          return _asyncToGenerator(function* () {
            ...
            smokeNode.setParent(_this.smokeLayer);
        ...
        generateTileMap() {
          ...
          return _asyncToGenerator(function* () {
            ...
            tileMapNode.setParent(_this2.stage);
        ...
        generatePlayer() {
          ...
          return _asyncToGenerator(function* () {
            ...
            playerNode.setParent(_this3.stage);
        ...
        generateEnemies() {
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = 0; i < _this4.level.enemies.length; i++) {
              var enemy = _this4.level.enemies[i];
        ...
        generateBurst() {
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = 0; i < _this5.level.bursts.length; i++) {
              var burst = _this5.level.bursts[i];
              var node = (_crd && createNewNode === void 0 ? (_reportPossibleCrUseOfcreateNewNode({
                error: Error()
              }), createNewNode) : createNewNode)();
        ...
        generateSpikes() {
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = 0; i < _this6.level.spikes.length; i++) {
              var spikes = _this6.level.spikes[i];
              var node = (_crd && createNewNode === void 0 ? (_reportPossibleCrUseOfcreateNewNode({
                error: Error()
              }), createNewNode) : createNewNode)();
        ...
        generateDoor() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield doorManager.init(_this7.level.door);
            (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
...
//# sourceMappingURL=a3c6c95ed9e7db87e778e1fee948270248a77551.js.map