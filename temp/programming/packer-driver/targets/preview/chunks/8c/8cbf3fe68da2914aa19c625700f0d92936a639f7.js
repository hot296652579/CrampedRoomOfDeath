  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerMrg", PlayerMrg = (_dec = ccclass('PlayerMrg'), _dec(_class = class PlayerMrg extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        willBlock(inputDirection) {
          ...
          if (inputDirection === (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              var checkDoor = this.checkCollisionDoor(_playerNextY2, _weaponNextY9, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT);
              if (checkDoor) return checkDoor;
              var checkEnemy = this.checkCollisionEnenies(_playerNextY2, _weaponNextY9, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT);
        ...
        checkCollisionEnenies(playerNextY, weaponNextY, state) {
          var {
            tartgetX: x,
            tartgetY: y,
            direction
          ...
          var enemies = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            ...
            error: Error()
          }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).DEATH); // 判断敌人
...
//# sourceMappingURL=8cbf3fe68da2914aa19c625700f0d92936a639f7.js.map