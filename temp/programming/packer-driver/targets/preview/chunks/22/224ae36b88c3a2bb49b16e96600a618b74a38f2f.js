          ...
          if (inputDirection === (_crd && ENUM_BOTTOM_CONTROLLER === void 0 ? (_reportPossibleCrUseOfENUM_BOTTOM_CONTROLLER({
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              for (var _i = 0; _i < enemies.length; _i++) {
                ...
                if (_enemyX === playerNextX && _enemyY === y || _enemyX === weaponNextX && _enemyY === _weaponNextY2) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKLEFT;
                  return true;
              ...
              for (var _i2 = 0; _i2 < enemies.length; _i2++) {
                ...
                if (_enemyX2 === playerNextX && _enemyY2 === y || _enemyX2 === _weaponNextX && _enemyY2 === _weaponNextY3) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKRIGHT;
                  return true;
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              for (var _i3 = 0; _i3 < enemies.length; _i3++) {
                ...
                if (_enemyX3 === _playerNextX && _enemyY3 === y || _enemyX3 === _weaponNextX2 && _enemyY3 === _weaponNextY4) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKLEFT;
                  return true;
              ...
              for (var _i4 = 0; _i4 < enemies.length; _i4++) {
                ...
                if (_enemyX4 === _playerNextX && _enemyY4 === y || _enemyX4 === _weaponNextX3 && _enemyY4 === _weaponNextY5) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKRIGHT;
                  return true;
              ...
              for (var _i5 = 0; _i5 < enemies.length; _i5++) {
                ...
                if (_enemyX5 === _playerNextX && _enemyY5 === y || _enemyX5 === _weaponNextX4 && _enemyY5 === y) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT;
                  return true;
              ...
              for (var _i6 = 0; _i6 < enemies.length; _i6++) {
                ...
                if (_enemyX6 === _playerNextX && _enemyY6 === y) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKBACK;
                  return true;
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              for (var _i7 = 0; _i7 < enemies.length; _i7++) {
                ...
                if (_enemyX7 === _playerNextX2 && _enemyY7 === y || _enemyX7 === _weaponNextX6 && _enemyY7 === _weaponNextY6) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKRIGHT;
                  return true;
              ...
              for (var _i8 = 0; _i8 < enemies.length; _i8++) {
                ...
                if (_enemyX8 === _playerNextX2 && _enemyY8 === y || _enemyX8 === _weaponNextX7 && _enemyY8 === _weaponNextY7) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKLEFT;
                  return true;
              ...
              for (var _i9 = 0; _i9 < enemies.length; _i9++) {
                ...
                if (_enemyX9 === _playerNextX2 && _enemyY9 === y) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKBACK;
                  return true;
              ...
              for (var _i10 = 0; _i10 < enemies.length; _i10++) {
                ...
                if (_enemyX10 === _playerNextX2 && _enemyY10 === y || _enemyX10 === _weaponNextX9 && _enemyY10 === y) {
                  this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                    error: Error()
                  }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT;
                  return true;
            ...
            if (direction === (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
              ...
              var _checkDoor = this.checkCollisionDoor(_playerNextY2, _weaponNextY9, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);

              if (_checkDoor) return _checkDoor;

              var _checkEnemy = this.checkCollisionEnenies(_playerNextY2, _weaponNextY9, (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
                error: Error()
              }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).BLOCKFRONT, inputDirection);
...
//# sourceMappingURL=224ae36b88c3a2bb49b16e96600a618b74a38f2f.js.map