      ...
      _export("WoodenMgr", WoodenMgr = (_dec = ccclass('WoodenMgr'), _dec(_class = class WoodenMgr extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        onLoad() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), ENUM_EVENT) : ENUM_EVENT).ENUM_CHECK_ATTACK, this.checkAttack, this);
        }
        ...
        onDestry() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), ENUM_EVENT) : ENUM_EVENT).ENUM_CHECK_ATTACK, this.checkAttack);
        }
...
//# sourceMappingURL=008c7c68ccd9c9ee087396997f4be6bb80ea1f22.js.map