    ...
    execute: function () {
      ...
      _export("EnemyMgr", EnemyMgr = (_dec = ccclass('EnemyMgr'), _dec(_class = class EnemyMgr extends (_crd && EnitiyMgr === void 0 ? (_reportPossibleCrUseOfEnitiyMgr({
        ...
        onChangeDirection(init) {
          ...
          var disY = Math.abs(this.y - playerY); //确保敌人在初始化的时候调整一次direction
        ...
        onLoad() {
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), ENUM_EVENT) : ENUM_EVENT).ENUM_MOVE_END, this.onChangeDirection, this); // EventMgr.Instance.addEventListen(ENUM_EVENT.ENUM_PLAYER_BORN, this.onChangeDirection, this)
        ...
        onDestroy() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), ENUM_EVENT) : ENUM_EVENT).ENUM_MOVE_END, this.onChangeDirection); // EventMgr.Instance.unEventListen(ENUM_EVENT.ENUM_PLAYER_BORN, this.onChangeDirection)
...
//# sourceMappingURL=f8cface4059befa836e3cb5e278f30cd212fe44d.js.map