System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, _decorator, DIRECTION_ENUM, ENITIY_TYPE_ENUM, ENTITY_STATE_ENUM, ENUM_EVENT, levels, EventMgr, DoorMgr, IronMgr, WoodenMgr, PlayerMrg, DataManager, TileMapManager, createNewNode, _dec, _class, _crd, TILE_WIDTH, TILE_HEIGHT, ccclass, property, UIBattleScene;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      IronMgr = _unresolved_6.IronMgr;
    }, function (_unresolved_7) {
      WoodenMgr = _unresolved_7.WoodenMgr;
    }, function (_unresolved_8) {
      PlayerMrg = _unresolved_8.PlayerMrg;
    }, function (_unresolved_9) {
      DataManager = _unresolved_9.default;
    }, function (_unresolved_10) {
      TileMapManager = _unresolved_10.TileMapManager;
    }, function (_unresolved_11) {
      createNewNode = _unresolved_11.createNewNode;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UIBattleScene", UIBattleScene = (_dec = ccclass('UIBattleScene'), _dec(_class = class UIBattleScene extends Component {
        ...
        initLevel() {
          ...
          this.generateTileMap(); // this.generateWooden()
          // this.generateIron()
        ...
        generateIron() {
          ...
          return _asyncToGenerator(function* () {
            ...
            ironNode.setParent(_this4.stage);
        ...
        generateDoor() {
          ...
          return _asyncToGenerator(function* () {
            ...
            doorNode.setParent(_this5.stage);
...
//# sourceMappingURL=5374f674f82ecca765c8a3f7f3673f9a687db92a.js.map