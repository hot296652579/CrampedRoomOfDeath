System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, TILE_TYPE_ENUM, DIRECTION_ENUM, ENTITY_STATE_ENUM, ENITIY_TYPE_ENUM, ENITIY_TYPE_SPIKES_ENUM, _crd, mapInfo, player, enemies, spikes, bursts, door, level;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "776008edZJJTKtqRvovELJd", "level10", undefined);
      ...
      enemies = [{
        ...
        type: (_crd && ENITIY_TYPE_ENUM === void 0 ? (_reportPossibleCrUseOfENITIY_TYPE_ENUM({
          error: Error()
        }), ENITIY_TYPE_ENUM) : ENITIY_TYPE_ENUM).IRON
      }, {
        x: 5,
        y: 5,
        direction: (_crd && DIRECTION_ENUM === void 0 ? (_reportPossibleCrUseOfDIRECTION_ENUM({
...
//# sourceMappingURL=c0fd3f749965e6cdac7f395a4a3ebe5eb54761af.js.map